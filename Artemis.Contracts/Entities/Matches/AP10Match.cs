...
namespace Artemis.Contracts.Entities.Matches
{
    public class AP10Match : BullseyeMatch
    {
        ...
        public AP10Match(MatchCreateRequestDto createRequest)
            : base(createRequest)
        {
        }

        public AP10Match(MatchUpdateRequestDto matchUpdateRequest)
            : base(matchUpdateRequest)
        {
        }

        public AP10Match(MatchOutputDto matchOutput)
            : base(matchOutput)
        {
        }
    }
